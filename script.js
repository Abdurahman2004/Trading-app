...
function updateDashboard() {
    ...
    profitToMakeEl.textContent = formatAmount(currentDayData.profitToBeMade);
    lostMoneyEl.textContent = formatAmount(currentDayData.lostMoney);
    savingAmountEl.textContent = formatAmount(currentDayData.savingBalance);
